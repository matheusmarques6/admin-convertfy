  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4 items-stretch">
        ...
        <div className="relative overflow-hidden rounded-[12px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-[#0f1419] dark:via-[#151d28] dark:to-[#0f1419] p-6 lg:p-8">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center rounded-[12px] bg-gradient-to-b from-primary/10 to-primary/5 dark:from-primary/15 dark:to-primary/5 border border-primary/15 dark:border-primary/20 px-8 min-w-[180px]">
...
function BreakdownCard({
  ...
  return (
    <div className={`rounded-[8px] border ${borderClass} ${bgClass} p-4 transition-all duration-200`}>
