...
function MetricRow({
  ...
  return (
    <div className="flex items-center justify-between py-2.5 border-b border-slate-200/50 last:border-0">
...
export function ListHealthMetrics({ klaviyo }: ListHealthMetricsProps) {
  ...
  const status = overallScore > 80
    ? { label: "Saudável", color: "text-emerald-600", ringColor: "stroke-emerald-600", bgColor: "bg-emerald-50" }
    : overallScore > 50
      ? { label: "Requer atenção", color: "text-amber-600", ringColor: "stroke-amber-600", bgColor: "bg-amber-50" }
      : { label: "Ação necessária", color: "text-red-600", ringColor: "stroke-red-600", bgColor: "bg-red-50" }
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-semibold text-slate-800">Saúde da Lista</h3>
      </div>
