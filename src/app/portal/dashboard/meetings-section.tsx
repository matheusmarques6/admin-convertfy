              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`rounded-lg p-2 ${isToday ? "bg-[#05AFF2]/15" : "bg-slate-100 dark:bg-slate-800"}`}>
              ...
              return (
                <div key={meeting.id} className="p-3 rounded-lg bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200/80 dark:border-slate-700/40">
                  ...
                  {meeting.completionNotes && (
                    <div className="bg-white dark:bg-[#1A1F2E] rounded-lg p-3 border-l-2 border-[#05AFF2]/30">
