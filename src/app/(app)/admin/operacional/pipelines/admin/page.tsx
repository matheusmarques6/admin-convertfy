...
/**
 * Pagina de administracao de pipelines de Customer Success.
 *
 * Espelho da contraparte comercial mas com scope=cs. Lista todos os
 * pipelines CS agrupados por categoria (Onboarding, Acompanhamento,
 * Renovacao, etc.) com KPIs (deals abertos, etapas) e CTAs pra abrir
 * o board, configurar etapas ou criar novo pipeline.
 *
 * Linkado via /admin/operacional/pipelines (footer "Configurar pipelines"
 * da sidebar V2 e botao "Configurar pipelines" no hero do empty state).
 */
export default function CsPipelinesAdminPage() {
  ...
  const [settingsPipeline, setSettingsPipeline] =
  ...
  const grouped = useMemo(() => {
    ...
    return Array.from(byCat.entries())
      ...
      .sort((a, b) => {
        // Categorias tipicas de CS: Onboarding -> Acompanhamento -> Renovacao -> Suporte
        const order = ["Onboarding", "Acompanhamento", "Renovacao", "Suporte", "Operacoes"]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Configure etapas, SLA e automações dos pipelines de pós-venda —
          Onboarding, Acompanhamento, Renovação e mais.
        </p>
          ...
          >
            <div
              ...
              style={{
                ...
                marginBottom: 20,
                borderRadius: 16,
                background: "var(--crm-green-50, #ECFDF5)",
                color: "#059669",
              }}
            >
            ...
            >
              Crie seu primeiro pipeline para organizar a gestão de sucesso
              do cliente — onboarding, ações de saúde, renovação e churn.
            </p>
            <button
              onClick={() => setNewDialogOpen(true)}
              className="cf-focusable inline-flex items-center gap-1.5 rounded-[6px]"
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2">
        <Link
          href={`/admin/operacional/pipelines/${pipeline.id}`}
