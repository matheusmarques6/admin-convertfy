...
import type { PortalCampaign, PortalCampaignApiResponse } from "@/lib/hooks/use-portal-campaigns-calendar"
...
interface CampaignsClientProps {
  initialCampaigns: PortalCampaignApiResponse[] | null
...
function CampaignsContent({
  ...
  const {
    ...
    initialData: initialCampaigns
      ? { campaigns: initialCampaigns, totalCount: initialTotalCount }
      : null,
  })
