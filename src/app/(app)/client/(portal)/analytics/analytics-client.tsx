...
const RevenueAreaChart = dynamic(
  () => import("./analytics-charts").then((mod) => ({ default: mod.RevenueAreaChart })),
  {
    loading: () => <Skeleton className="h-[200px] sm:h-[240px] w-full rounded-[8px]" />,
    ssr: false,
  }
)
const AudienceDonut = dynamic(
  () => import("./analytics-charts").then((mod) => ({ default: mod.AudienceDonut })),
  {
    loading: () => <Skeleton className="h-[120px] w-full rounded-[8px]" />,
    ssr: false,
  }
)
...
export function AnalyticsClient({ initialData, initialStoreId }: AnalyticsClientProps) {
