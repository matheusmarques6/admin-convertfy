...
interface IntegrationsClientProps {
  initialData: IntegrationsInitialData | null
  initialStoreId: string | null
}

export function IntegrationsClient({ initialData, initialStoreId }: IntegrationsClientProps) {
  const [loading, setLoading] = useState(!initialData)
  const [error, setError] = useState<string | null>(null)
  const [store, setStore] = useState<StoreInfo | null>(initialData?.store ?? null)
  const [integrations, setIntegrations] = useState<IntegrationData | null>(initialData?.integrations ?? null)
