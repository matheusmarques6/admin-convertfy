...
export default function CsFormsListPage() {
  ...
  return (
    <CrmPageShell
      title="Formulários de CS"
      subtitle="NPS, health check, feedback pós-call — capturam respostas dos seus clientes e criam leads CS."
      actions={
        <button
