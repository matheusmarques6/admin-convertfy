      ...
      if (result.success && result.data) {
        ...
        if (result.data.flowRows.length > 0) {
          await supabase
            ...
            .upsert(result.data.flowRows, { onConflict: "store_id,flow_id,period_start,period_end" })
        }
        ...
        if (result.data.campRows.length > 0) {
          await supabase
            ...
            .upsert(result.data.campRows, { onConflict: "store_id,campaign_id,period_start,period_end" })
        }
