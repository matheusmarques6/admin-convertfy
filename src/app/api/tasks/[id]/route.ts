...
/**
 * Retorna mensagem de bloqueio se a task tem target de producao de email
 * e os emails correspondentes nao estao aprovados/live. null = OK pra
 * completar.
 */
async function guardEmailProductionCompletion(
