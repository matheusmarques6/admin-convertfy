...
export interface QaIssue {
   ...
   *
   * Nasceu no gate determinístico e SUMIU no merge do PR #20 (a resolução
   * levou a versão da interface do outro ramo inteira), quebrando o build
   * com 16 erros nos produtores — que continuavam emitindo o campo. O
   * consumidor sumiu junto (ver `phase2-runner.service.ts`). */
...
export interface EmailGenerationSettings {
  ...
  // Seletor de objeções (set/2026, migration 20261116): 'shadow' roda e
  // grava o alvo por email sem ninguém consumir; 'on' desce para o
  // Estruturador, o Curador e a copy.
  seletor_mode: "off" | "shadow" | "on"
