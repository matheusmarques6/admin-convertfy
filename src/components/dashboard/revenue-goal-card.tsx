    ...
    return (
      <>
        <button
          ...
          className="rounded-[6px] border border-dashed border-border bg-card p-5 hover:bg-accent/50 transition-colors w-full text-left"
        >
    ...
    <>
      <div className="rounded-[6px] border border-border bg-card p-5 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={cn(
              "h-10 w-10 rounded-[6px] flex items-center justify-center",
