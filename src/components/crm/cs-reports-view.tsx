...
/**
 * Reports de Customer Success — série temporal da carteira agregada.
 *
 * Era a página /admin/operacional/reports; virou a aba "Tendências" do
 * Monitor de Saúde (/admin/health?tab=tendencias) — a rota antiga
 * redireciona. Visível apenas para quem tem a permissão `ops.reports`
 * (gate na página de Saúde).
 *
 * Consome /api/crm/reports/timeseries (snapshots diários, cron 06h UTC)
 * e mostra apenas campos CS-relevantes:
...
export function CsReportsView() {
  ...
  return (
    <div className="space-y-6">
      {/* Controles da aba: janela + export */}
      <div className="flex items-center justify-between gap-3">
        <p className="text-[12px] text-gray-500 dark:text-white/50 m-0">
          Saúde da carteira agregada · janela {days}d · snapshot diário 06h UTC
        </p>
