-- =============================================
-- PIPELINE FILE 07: UNIFY REPORTS SYSTEM
-- =============================================
-- Adds: user_id, document_url, notes, status columns to client_reports
-- Creates: Indexes for new columns
-- Migrates: Data from old reports table
-- Creates: RLS update policy
-- Creates: reports_legacy view
-- =============================================
...
DO $$
BEGIN
  -- Only run if the reports table exists
